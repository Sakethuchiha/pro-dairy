      ...
      <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            ...
            <p className="text-3xl font-bold mt-2">3,790 <span className="text-sm font-normal text-gray-500">Liters</span></p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <h3 className="text-sm font-medium text-gray-500">Today's Collection</h3>
            <p className="text-3xl font-bold mt-2">1,245 <span className="text-sm font-normal text-gray-500">Liters</span></p>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <h3 className="text-sm font-medium text-gray-500">Quality Pass Rate</h3>
            <p className="text-3xl font-bold mt-2">98<span className="text-sm">%</span></p>
          </div>
        </div>
          ...
          <div className="divide-y divide-gray-100">
            {procurementRoutes.map(route => (
              <div key={route.id} className="p-4 flex justify-between items-center hover:bg-gray-50">
                ...
                <p className="font-semibold">{route.quantity} {route.unit}</p>
              </div>
            ))}
          </div>
        </div>
